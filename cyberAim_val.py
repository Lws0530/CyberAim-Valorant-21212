...
logging.basicConfig(level=loggingStatus,
                    ...
                    handlers=[
                        logging.FileHandler("logs/recoil_m.logs"),
...
handler = logging.FileHandler("logs/recoil_m.logs")
...
def object_detection():
    ...
    while True:
        ...
        if enemyNum == 0:
            ...
            if (is_aim_key_pressed() and closestObjectDistance < AIM_FOV) or ALWAYS_ON:
